...
import 'schema/confeitaria_record.dart';
...
export 'schema/confeitaria_record.dart';
...
Future<int> queryCestasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
/// Functions to query ConfeitariaRecords (as a Stream and as a Future).
Future<int> queryConfeitariaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ConfeitariaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ConfeitariaRecord>> queryConfeitariaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ConfeitariaRecord.collection,
      ConfeitariaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ConfeitariaRecord>> queryConfeitariaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
